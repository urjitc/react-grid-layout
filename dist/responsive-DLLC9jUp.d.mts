import { a as LayoutItem, L as Layout, C as CompactType, B as Breakpoint, b as Breakpoints, R as ResponsiveLayouts } from './types-APYmAsR1.mjs';
 ...
 */
declare function collides(l1: LayoutItem, l2: LayoutItem, threshold?: number): boolean;
/**
 ...
 */
declare function getFirstCollision(layout: Layout, layoutItem: LayoutItem, threshold?: number): LayoutItem | undefined;
/**
 ...
 */
declare function getAllCollisions(layout: Layout, layoutItem: LayoutItem, threshold?: number): LayoutItem[];
