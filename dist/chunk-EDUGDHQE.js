...
function GridItem(props) {
    ...
    (e, { node, deltaX, deltaY }) => {
      ...
      if (isBounded) {
        ...
        if (offsetParent) {
          ...
          const rightBoundary = containerWidth - chunkA5WIFECI_js.calcGridItemWHPx(w, colWidth, margin[0]);
  ...
  const minGridUnit = chunkA5WIFECI_js.calcGridItemPosition(positionParams, 0, 0, 1, 1);
